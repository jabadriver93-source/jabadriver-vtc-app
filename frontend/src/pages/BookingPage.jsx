...
const LOGO_HEADER_URL = "/jabadriver-logo-v2.png";
  ...
  return (
    <div className="hero-map relative">
      ...
      <div className="hero-map-content">
        {/* Header - Logo absolutely centered + Hamburger fixed right */}
        <header className="header-mobile-fixed">
          ...
          {/* Hamburger Menu Button - Fixed right with safe margin */}
          <button 
        ...
        {/* Hero Section - Proper spacing from logo */}
        <section className="px-5 pt-6 sm:pt-8 pb-4 sm:pb-6">
